...
const CONFIG = {
  title:      "maccha2D",
  tagline:    "2Dアクションゲーム（ver 51）",   // ← ページが新しくなったか確認する目印。不要なら消してOK
...
const GROW_RATIO  = 0.04; // 敵を踏んで吸収したとき、その敵の大きさの何割だけ大きくなるか（端数は貯まっていくので、無駄にはならない）
const KAKERA_GROW_RATIO = 0.008; // かけらを拾ったときは、敵を直接吸収するときよりずっと大きくなりにくい（かけらの大きさの何割が実際の成長になるか）
