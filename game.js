...
const CONFIG = {
  title:      "maccha2D",
  tagline:    "2Dアクションゲーム（ver 32）",   // ← ページが新しくなったか確認する目印。不要なら消してOK
...
const GROW_RATIO  = 0.0025; // 敵を踏んで吸収したとき、その敵の大きさの何割だけ大きくなるか（端数は貯まっていくので、無駄にはならない）
