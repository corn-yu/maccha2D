...
const CONFIG = {
  title:      "maccha2D",
  tagline:    "2Dアクションゲーム（ver 71）",   // ← ページが新しくなったか確認する目印。不要なら消してOK
...
const BOSS_DATA_SCALE = 1;  // ボスの「サイズの数値」(en.size)は、見た目・当たり判定(en.w/en.h)と同じにする
...
const ENEMY_JUMP_CHANCE = 0.4; // ジャンプの条件が揃ったとき、実際に跳ぶ確率（低いほど「たまに」跳ぶ感じになる）
...
const game = {
  ...
  splitEnemy(e) {
    e.vz = 90; e.grounded = false;   // ジャンプではなく、ぶつかった反動の小さな跳ねにとどめる
    this.kick(e.spr, 8);
